...
;
	...
	; ENDIF
;
	DEFS 0F0H - $, 0	; Pad to offset 0xF0 (address 0x1F0 when linked at 0x100)
;
OFFLO:	DEFW	0		;TIME OFFSET LO
OFFHI:	DEFW	0		;TIME OFFSET HI
	DEFB	80		;WIDTH
	DEFB	07H	;CURSOR UP
	DEFB	0FH	;CURSOR DOWN
	DEFB	06H	;START OF LINE
	DEFB	0EH	;END OF LINE
	DEFB	18H	;DELETE TO END OF LINE
	DEFB	08H		;BACKSPACE & DELETE
	DEFB	15H	;DEL TO START OF LINE
	DEFB	0AH	;CURSOR LEFT
	DEFB	0CH	;CURSOR RIGHT
	DEFB	12H	;DELETE CHARACTER
	DEFB	11H	;INS/OVR TOGGLE
;
FIN: ; END
